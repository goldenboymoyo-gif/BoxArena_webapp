document.addEventListener('DOMContentLoaded', () => {
  ...
  const fighters = {
    ...
    nontshinga: { name: 'Sivenathi Nontshinga', country: 'South Africa', record: '13-1 (10 KOs)', weight: 'Light Flyweight', height: "5'3\"", reach: '64"', age: '26', stance: 'Orthodox', img: './images/Pitius.jpg', titles: 'IBF Light Flyweight World Champion', bio: 'Sivenathi Nontshinga is the IBF Light Flyweight world champion from South Africa. At just 26 years old, he has already defended his world title twice.' },
